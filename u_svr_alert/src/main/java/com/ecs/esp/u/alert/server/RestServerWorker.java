package com.ecs.esp.u.alert.server;
		...
		try {
			...
			if(obj instanceof RESTStringData data) {
				...
				if(msg != null) {
                    ...
                    if (msg.getMessageID() == RESTMessage.REQ_REST_TALK_ALERT) {
                        ...
                        EThread.postMessage(Define.TID_ALERT_WORKER, SetMessageData(msg));
                    } else {
                        Send(data, HttpResponseStatus.BAD_REQUEST);
